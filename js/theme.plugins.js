;(function(){
	...
	$(window).load(function(){
		...
		------------------------------------------------ */
			...
			$('.owl_carousel.one_item').owlCarousel({
				responsive : {
					0 : {
						items : 1
					},
	...
	//jQuery('.cats').prepend('<span class="remove"></span>');
	jQuery('.mega_menu').click(function(e){
		e.stopPropagation();
	});

	jQuery('.has_megamenu ul li').click(function(e){
		e.stopPropagation();
	...
	jQuery('.cats .has_megamenu').click(function(e){
		...
		jQuery('.cats').toggleClass('open');
		jQuery(this).siblings().find('ul li .has_megamenu').removeClass('active');
	});
	
	jQuery(document).click(function(){
		jQuery('.cats .has_megamenu.active').removeClass('active');
		jQuery('.has_megamenu ul li').find('.has_megamenu').removeClass('active');
		jQuery('.cats').removeClass('open');
	});

/*
	jQuery('.cats .remove').click(function(){
		jQuery('.cats .has_megamenu.active').removeClass('active');
		jQuery('.has_megamenu ul li').find('.has_megamenu').removeClass('active');
		jQuery('.cats').removeClass('open');
	});
